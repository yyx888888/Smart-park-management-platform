  ...
  <el-container>
    <el-header>
      <div class="title">
        ...
        <span class="headerTitle">充电桩管理</span>
      </div>
      <!-- 只有页面是设备列表时才展示按钮 -->
    ...
    <el-main>
      <el-menu
        ...
        mode="horizontal"
        router
        default-active="/property/chargingPile/DeviceList"
      >
        <el-menu-item index="/property/chargingPile/DeviceList"
          >设备列表</el-menu-item
        >
        <el-menu-item index="/property/chargingPile/AlarmRecord"
          >告警记录</el-menu-item
        >
        <el-menu-item index="/property/chargingPile/Operations"
          >运维记录</el-menu-item
        >
      </el-menu>
